        ...
        <?php
            ...
            <div class="col-md-5 bg-light text-dark">
                ...
                <form>
                    ...
                    <label>ส่วนลด</label>
                    <input type="number" name="discount" class="form-control" value="<?php echo $row['pro_discount']?>" readonly>
                    <label>วันที่เริ่มต้น</label>
                    <input type="date" name="sdate" class="form-control" value="<?php echo $row['pro_sdate']?>" readonly>
                    <label>วันที่สิ้นสุด</label>
                    <input type="date" name="edate" class="form-control" value="<?php echo $row['pro_edate']?>" readonly>
                    ...
                    foreach ($bookarr as $value) {
                        ...
                        echo '<input type="checkbox" name="book[]" value="' . $value . '" ' . $isChecked . ' disabled> ' . $bookname;
                    }                                        
                }
                connectdb()->close();
                    ?><br><br>
