    ...
    <section class="page-section portfolio" id="portfolio">
        <div class="container">
            ...
            <div text-align="left">
                ...
                <h2 class="page-section-heading text-center text-uppercase text-secondary mb-0">TYPE BOOK Manage</h2>
            </div>
                ...
                <tr>
                    ...
                    <td>
                        <?php if ($permis) { ?>
                            ...
                            <a href="typebookedit.php?id=<?= $row["type_id"] ?>" class="btn btn-primary">Edit</a>
                            <a href="typebookdel.php?id=<?= $row["type_id"] ?>" class="btn btn-danger"
