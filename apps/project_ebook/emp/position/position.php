    ...
    <section class="page-section portfolio" id="portfolio">
        <div class="container">
            ...
            <div text-align="left">
                ...
                <h2 class="page-section-heading text-center text-uppercase text-secondary mb-0">Position Manage</h2>
            </div>
    ...
    <div style="text-align: center;">
        <table class="table table-hover">
            ...
            if (isset($_POST['submit'])) {
                $search = $_POST['search'];
                $result = selectWhere('*','position',"upper(pos_id) like upper('$search%') or upper(pos_name) like upper('$search%')");
            }else{
                ...
                <tr>
                    ...
                    <td>
                        <?php if ($permis) { ?>
                            ...
                            <a href="positionedit.php?id=<?= $row["pos_id"] ?>" class="btn btn-primary">Edit</a>
                            <a href="positiondel.php?id=<?= $row["pos_id"] ?>" class="btn btn-danger"
                                onclick="return confirm('Are you sure you want to DELETE ?')">Del</a>
                        <?php }else{ ?>
                            <a href="positionedit.php?id=<?= $row["pos_id"] ?>" class="btn btn-success">View</a>
                        <?php } ?>
